...
private:
  ...
  std::vector<bool> _shower_matched_MCP;
  ...
  void get_true_energy_dep_daughters(const std::vector<simb::MCParticle>& event_mcp, const simb::MCParticle& mcparticle, std::vector<double>& energy_dep);
  /**
